...
/**
 * sLGSeven Problems(problem 3)
 * sLGSeven function takes a number as input and check the number  and do some arithmetic operation 
 and returns the result of the following operations 
 * @param {*} number_data 
 * @returns result of the following operations
 */

function sLGSeven(number_data) {
...
//test cases
/* console.log(sLGSeven("Phero"));
console.log(sLGSeven(6));
console.log(sLGSeven(-15));
console.log(sLGSeven(15)); */
